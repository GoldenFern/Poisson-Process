...
$$
T_i-T_{i-1}\stackrel{i.i.d.}{\sim}\mathrm{Exp}(\lambda).
$$
...
\qquad
\mathbb{E}[N(t)] = \mathrm{Var}(N(t)) = M(t).
$$
...
\qquad
\mathrm{Var}(S(t)) = \lambda t\,\mathbb{E}[J^2].
$$
...
$$
N(t)\mid\Lambda \sim \mathrm{Poisson}(\Lambda t).
$$
...
$$
\mathrm{Var}(N(T))
= \mathbb{E}[\Lambda]T+\mathrm{Var}(\Lambda)T^2.
$$
...
\qquad
\mathbb{E}[N(A)] = \mathrm{Var}(N(A)) = \lambda |A|.
$$
